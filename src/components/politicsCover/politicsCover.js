    ...
    return(
      <div style={styles.container}>
        ...
        <div style={styles.textContainer}>
          ...
          <br/>
          <br/>
          <center><Header as={'h1'} inverted style={{fontWeight:500,fontSize:30}}>This section is about politics in its widest sense and includes legislation, conflicts and decision-making.</Header></center>
        </div>
